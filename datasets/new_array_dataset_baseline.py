...
@gin.configurable
class GenDataset():
    def __init__(self, loggers, path, gamma, max_horizon, length = 20, noise_prob = 0., min_ind=None, max_ind=None, max_size=None, sampling_probability='uniform', device='cpu'):
