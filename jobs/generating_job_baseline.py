...
from search.value_function_baseline import ValueEstimatorRubik
...
class TrainJob():
    ...
    def gen_plot_distances(self):        
        ...
        for i, s in enumerate(self.test_trajectories):
            distances = value_estimator.get_solved_distance_batch(s)
